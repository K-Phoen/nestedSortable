(function($, undefined) {
  ...
  $(document).ready(function(){
    ...
    test('Try to export a basic tree with "toArray"', function() {
      var tree = $('#simple_tree').nestedSortable({getItemId: getItemId});
    ...
    test('Try to export a basic tree with "toHierarchy"', function() {
      var tree = $('#simple_tree').nestedSortable({getItemId: getItemId});
      var tree_hierarchy = tree.nestedSortable('toHierarchy');

      deepEqual(tree_hierarchy, [
        {"id": "1_1"},
        {"id": "1_2", "children": [
          {"id": "2_1"},
          {"id": "2_2", "children": [
        ...
        {"id": "1_3"}],
        'The exported hierarchy is correct.'
      );
    });
    ...
    test('Try to export a tree with multiple roots with "toHierarchy"', function() {
      ok(false, "this test fails");
    });
  });
})(jQuery);
